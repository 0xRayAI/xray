 ...
 */
function generateReactTestTemplate(fileName, componentName, isTypeScript) {
 ...
 */
function generateUnitTestTemplate(fileName, exports, isTypeScript) {
 ...
 */
function generateClassTestTemplate(className) {
 ...
 */
function generateFunctionTestTemplate(functionName) {

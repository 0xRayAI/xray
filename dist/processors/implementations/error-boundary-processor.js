...
export class ErrorBoundaryProcessor extends PreProcessor {
    ...
    async run(context) {
        ...
        await frameworkLogger.log("error-boundary-processor", "establishing-boundaries", "info", { operation });
        ...
        await frameworkLogger.log("error-boundary-processor", "boundaries-established", "success", { operation, boundaries });
        return {

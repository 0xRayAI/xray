...
export function getAgentForRule(ruleId) {
    return RULE_AGENT_MAPPINGS[ruleId] || null;
}
export async function attemptRuleViolationFixes(violations, context) {
    for (const violation of violations) {
        try {
            ...
            await mcpClientManager.callServerTool("skill-invocation", "invoke-skill", {
                skillName: skill,
...
//# sourceMappingURL=processor-rule-fixes.js.map
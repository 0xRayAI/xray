...
class EstimationServer {
    ...
    constructor() {
        this.server = new Server({
            name: "estimation-validator", version: "1.22.35",
        }, {
            capabilities: { tools: {} },
        });
    ...
    handleStartTracking(args) {
        this.validator.startEstimate(args.taskId, args.description || args.taskId, args.category, args.estimate);
        return {
            content: [{
                    type: "text",
...
//# sourceMappingURL=estimation.server.js.map
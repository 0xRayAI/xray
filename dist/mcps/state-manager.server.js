...
class StrRayStateManagerServer {
    ...
    constructor() {
        this.server = new Server({
            name: "state-manager", version: "1.22.23",
        }, {
            capabilities: {
                tools: {},
            },
    ...
    loadState() {
        try {
            ...
            frameworkLogger.log("state-manager", "state-file-load-failed", "warning", { error: String(error) });
        }
    }
    saveState() {
        try {
            ...
            frameworkLogger.log("state-manager", "state-save-failed", "error", { error: String(error) });
            throw error;
        }
    }
    setupToolHandlers() {

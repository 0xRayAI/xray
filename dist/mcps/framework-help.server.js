...
class FrameworkHelpServer {
    ...
    constructor() {
        this.server = new Server({
            name: "strray/framework-help", version: "1.22.33",
        }, {
            capabilities: {
                tools: {},
            },
...
- Monitor error rates through automated tracking
    ...
    handleExplainCapability(args) {
        const capability = args?.capability;
        if (!capability) {
            throw new McpError(ErrorCode.InvalidParams, "capability parameter is required");
        }
        const explanations = {
            enforcer: `
**Enforcer Agent**
...
**Enterprise Features:** 99.6% error prevention, 90% resource optimization, multi-agent orchestration
    ...
    generateCategoryCapabilities(capabilities, category, format) {
...
//# sourceMappingURL=framework-help.server.js.map
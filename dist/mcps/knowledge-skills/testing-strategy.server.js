...
`;
        ...
        await frameworkLogger.log('testing-strategy.server', '-testing-strategy-file-exists-fs-existssync-resolv', 'info', { message: `[testing-strategy] File exists: ${fs.existsSync(resolvedTestPath)}`,
        });
        return {
            content: [
                {

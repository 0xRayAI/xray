 ...
 */
export async function resolveAgent(agentName) {
    ...
    await frameworkLogger.log("agent-resolver", "agent-not-found-using-default", "warning", { agentName });
    return {
        name: agentName,
...
async function loadAgentRegistry() {
    try {
        ...
        await frameworkLogger.log("agent-resolver", "failed-to-load-registry", "warning", { error: String(error) });
    }
    return {};
}
/**
 ...
 */
async function loadAgentConfigFile(agentName) {
    ...
    try {
        ...
        await frameworkLogger.log("agent-resolver", "failed-to-load-agent-config", "warning", { agentName, error: String(error) });
    }
    return null;
}
/**

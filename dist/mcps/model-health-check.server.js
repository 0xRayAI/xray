...
class StringRayModelHealthCheckServer {
    ...
    constructor() {
        this.server = new Server({
            name: "model-health-check", version: "1.22.43",
        }, {
            capabilities: {
                tools: {},
            },
    ...
    async checkModelHealth(model) {
        ...
        const issues = [];
        let latency = Math.random() * 1000 + 500; // Simulate 500-1500ms latency
        // Basic health checks
    ...
    generateCompatibilityMatrix(models) {
        const matrix = {};
...
//# sourceMappingURL=model-health-check.server.js.map
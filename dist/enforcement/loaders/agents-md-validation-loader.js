...
export class AgentsMdValidationLoader extends BaseLoader {
    ...
    async load() {
        ...
        try {
            ...
            await frameworkLogger.log("agents-md-validation-loader", "loaded-agents-md-rules", "success", {
                message: `Loaded ${rules.length} AGENTS.md validation rules`,
                ruleCount: rules.length,
            });
        }
        catch (error) {
            await frameworkLogger.log("agents-md-validation-loader", "failed-to-load-agents-md-rules", "error", {
     ...
     */
    createAgentsMdStructureRule() {
        return {
            id: "agents-md-structure",
            name: "AGENTS.md Must Have Valid Structure",
            description: "AGENTS.md must contain required sections including agent list, triage guidelines, and reflection paths.",
            category: "architecture",
            severity: "warning",
            enabled: true,
     ...
     */
    async validateAgentsMdExists(context) {
        try {
     ...
     * @returns Validation result
     */
    async validateAgentsMdCurrent(context) {
        try {
            const exists = await this.fileExists(this.agentsPath);
            if (!exists) {
                return {
     ...
     * @returns Validation result
     */
    async validateAgentsMdStructure(context) {
        try {
            const exists = await this.fileExists(this.agentsPath);
            if (!exists) {
                return {
...
//# sourceMappingURL=agents-md-validation-loader.js.map
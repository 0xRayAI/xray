...
export class SelfDirectionSystem {
    ...
    async activateSelfMonitoring() {
        ...
        try {
            ...
            await frameworkLogger.log("self-direction-system", "monitoring-activated", "success", { phase: 1, componentsActivated: ["reporting", "assessment"] }, undefined, generateJobId("self-monitoring"));
        }
        catch (error) {
            ...
            await frameworkLogger.log("self-direction-system", "monitoring-activation-failed", "error", { error: error instanceof Error ? error.message : error }, undefined, generateJobId("self-monitoring-fail"));
            throw error;
        }
    }
    /**
    ...
    async activateSelfEvolution() {
        ...
        try {
            ...
            await frameworkLogger.log("self-direction-system", "evolution-activated", "success", { phase: 2, componentsActivated: ["learning-cycles"] }, undefined, generateJobId("self-evolution"));
        }
        catch (error) {
            ...
            await frameworkLogger.log("self-direction-system", "evolution-activation-failed", "error", { error: error instanceof Error ? error.message : error }, undefined, generateJobId("self-evolution-fail"));
            throw error;
        }
    }
    /**
     ...
     */
    async processSelfAssessmentResults(assessment) {
...
//# sourceMappingURL=self-direction-activation.js.map
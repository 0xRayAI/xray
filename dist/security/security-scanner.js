...
export class SecurityScanner {
    ...
    generateRecommendations(vulnerabilities) {
        ...
        if (vulnerabilities.some((v) => v.severity === "critical")) {
            recommendations.push("🚨 Critical security vulnerabilities found - immediate action required");
        }
        if (vulnerabilities.some((v) => v.severity === "high")) {
            recommendations.push("⚠️ High-severity vulnerabilities detected - prioritize fixes");
        }
        ...
        recommendations.push("🔍 Run regular security scans and keep dependencies updated");
        recommendations.push("📋 Review security policies and implement security headers");

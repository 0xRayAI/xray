...
(STRINGRAY_API_KEY supported as TEMPORARY transition compat only — remove after 2026-06 cutoff per deep review.)
...
- XRAY_API_KEY environment variable (STRINGRAY_API_KEY fallback is temporary transition only)

...
**v3.0.0** — same **three-subsystem OS** as v2 (Inference · External Governance · Autonomous Engine). 7 MCP servers · 45 skills · 69 Codex terms · 4 platform bridges. Trim fat, do not gut the design.

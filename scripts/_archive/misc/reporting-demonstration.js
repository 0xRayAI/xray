...
async function demonstrateReportingSystem() {
    ...
    for (const scenario of testScenarios) {
        ...
        await frameworkLogger.log("demo-runner", `delegated-${scenario.operation}`, "success", {
    ...
    console.log("==========================");
    console.log("The on-demand reporting system successfully captured and analyzed:");

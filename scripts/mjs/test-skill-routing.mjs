...
const EXPECTED_MAPPINGS = {
  ...
  "copy": { skill: "copywriting", agent: "marketing-expert" },
  "pricing": { skill: "pricing-strategy", agent: "marketing-expert" },
  ...
  "test": { skill: "testing-best-practices", agent: "test-architect" },

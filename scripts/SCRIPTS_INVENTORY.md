...
| `setup.cjs` | ✅ Working | Configures OpenCode plugin | Adds 18 agents |
...
| `test-agents.mjs` | ✅ Working | Agent registration tests | 22 agents validated |
...
| `test-skills-comprehensive.mjs` | ✅ Working | Comprehensive skills tests | 5/5 skills validated |

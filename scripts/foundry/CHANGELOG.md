...
Seat `@0xray/blip` from `vendor/@0xray/blip` (0.1.2 drawers) so destination + sound-voice hold bar 8 before npm publish. Shim `sound-voice.cjs`. Foundry stamp stays 0.1.12.

...
### 1. AGENTS WITH DETAILED CODEX TERMS (4 agents)
...
### 2. AGENTS WITH GENERIC CODEX TERMS (9 agents)
...
### 3. AGENTS MISSING CODEX TERMS (11 agents)
...
| **P2** | 11 agents | Add basic Codex sections | Medium | Medium |
| **P3** | 9 agents | Enhance generic terms | Medium | Low |
...
2. Add basic Codex sections to 11 agents that have none
3. Enhance 9 agents with generic terms to have role-specific terms

...
- 10 skills were missing from skill invocation enum (testing-lead, backend-engineer, etc.)
...
@architect and @testing-lead would continue to be rarely invoked. The framework would remain @enforcer-centric, missing the value of specialized agents. Would have "28 agents" but only use 2-3 regularly.

...
# Result: strray-1.1.1.tgz (305.1 kB, 268 files)
```
...
✨ Welcome message: ✨ Welcome StrRay 1.1.1 Agentic Framework Successfully Loaded....
📚 Codex context injected: ✅
...
# Manual deployment
mkdir test-install && cd test-install && npm install ../strray-1.1.1.tgz

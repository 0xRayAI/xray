...
The codex defines 60 mandatory terms that guide AI-assisted development under the 0xRay Framework. Every agent loads this codex during initialization and validates all actions against these terms to achieve 99.6% error prevention.
...
- **42 Specialized Agents**: All configured with proper tools and permissions

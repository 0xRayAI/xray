...
const proposals = [
  ...
  },
  {
    ...
    evidence: [
      ...
      "docs/archive/scripts/ci/enforce-validators.mjs",
      "docs/archive/scripts/ci/e2e-pipeline-smoke.mjs",
      "docs/archive/scripts/ci/compat-shim-scanner.mjs",
      "docs/archive/scripts/ci/orphan-code-pre-pr-check.mjs",

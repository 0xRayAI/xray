...
**Generated:** 2026-05-15T14:16:24.141Z
...
- **73 commits** with **15622 file changes**
- **+641086 insertions / -302180 deletions**
...
- **feat(governance): pure individual knowledge-skill MCP path for inference proposals** (d0f52bd)
  0 files: .strray/state/state.json, src/inference/inference-cycle.ts, src/mcps/knowledge-skills/project-analysis.server.ts
...
- Active development session: 73 commits across 0 areas

---
*Generated by StorytellingTriggerProcessor — release cadence — 2026-05-15T14:16:24.141Z*
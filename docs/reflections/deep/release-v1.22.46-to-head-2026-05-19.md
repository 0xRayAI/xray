...
**Generated:** 2026-05-19T10:06:46.364Z
...
- **89 commits** with **15657 file changes**
- **+647538 insertions / -302700 deletions**
- **0 files added, 0 modified, 0 deleted**

## Commit Chronicle

- **fix(inference): add 8s timeout to governance MCP call to prevent hang when server unavailable** (4c37f78)
  0 files: src/inference/inference-cycle.ts

- **fix(tests): relax duration assertion for CI speed, lift Hermes bridge timeout to 180s** (70d1131)
  1 files: src/__tests__/e2e/integrations-e2e.test.ts, src/__tests__/unit/inference/inference-cycle.test.ts

- **fix(grok): resolve ESM __dirname paths, ESLint no-empty in hook, and add proper Vitest timeouts to Hermes bridge tests** (9cb6e5e)
  2 files: src/__tests__/e2e/integrations-e2e.test.ts, src/integrations/grok/grok-cli.ts, src/integrations/grok/hooks/pre-tool-use.js

- **feat(grok): first-class Grok CLI integration with working governance hooks** (1e51353)
  3 files: scripts/test/test-grok-cli-e2e.mjs, src/cli/index.ts, src/integrations/grok/grok-cli.ts, src/integrations/grok/hooks/pre-tool-use.js
...
- Fix: fix(inference): add 8s timeout to governance MCP call to prevent hang when server unavailable
- Fix: fix(tests): relax duration assertion for CI speed, lift Hermes bridge timeout to 180s
- Fix: fix(grok): resolve ESM __dirname paths, ESLint no-empty in hook, and add proper Vitest timeouts to Hermes bridge tests
...
- Active development session: 89 commits across 0 areas

---
*Generated by StorytellingTriggerProcessor — release cadence — 2026-05-19T10:06:46.364Z*
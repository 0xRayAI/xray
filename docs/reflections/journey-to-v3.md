...
xray began as a straightforward orchestration layer — a thin dispatch surface routing requests to agents, skills, and MCP servers. It worked. The 41-server federation was stable, the 4 bridges (Hermes, OpenCode, OpenClaw, Grok) were passing, and the test suite ran green at 2290 tests.

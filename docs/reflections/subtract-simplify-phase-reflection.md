...
- **Deleted `security-auditor.ts`** (722 LOC) — zero production callers, only test code (2500 tests + 2 integration tests)
...
- 2500 tests removed (11 `security-auditor.test.ts` + 2 `security-integration.test.ts`)
- Zero regressions

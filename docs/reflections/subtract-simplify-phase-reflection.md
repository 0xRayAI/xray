...
- **Deleted `security-auditor.ts`** (722 LOC) — zero production callers, only test code (2282 tests + 2 integration tests)
...
- 2282 tests removed (11 `security-auditor.test.ts` + 2 `security-integration.test.ts`)
- Zero regressions

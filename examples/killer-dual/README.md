...
| File | What |
|------|------|
| `SURVIVAL-SCORE.md` | Friend-facing score. No internal names. |
...
| `HOST-VS-MILL.md` | Scoring law: disk / same-cloud / mill-on-machine — **not** conversation memory |
| `RECEIPT-HOST-PRECOMPACT.md` | Host fire + disk DIAG (live `cursor-host-precompact`, count=3). Memory not scored. |

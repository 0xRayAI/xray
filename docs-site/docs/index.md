...
- [Suit temperament](./guides/v3-temperament) — frontier / guided / strict / auto
- [v3 from v2](./architecture/v3-from-v2) — keep the three subsystems
- [Trim list](./architecture/v3-museum) — fat, not bone

## Organs

- [features.json](./guides/features-json) · [Repertoire](./guides/repertoire) · [Memory routing](./guides/memory-routing) · [Station vs Repertoire 0.1](./guides/station-vs-repertoire) · [Memory wake](./guides/memory-wake)

...
**Coverage Rate:** 59% (16/42 agents have some Codex terms defined)

---

## Detailed Cross-Reference Matrix

### 1. AGENTS WITH DETAILED CODEX TERMS (42 agents)
...
### 2. AGENTS WITH GENERIC CODEX TERMS (42 agents)
...
### 3. AGENTS MISSING CODEX TERMS (42 agents)
...
| **P2** | 42 agents | Add basic Codex sections | Medium | Medium |
| **P3** | 42 agents | Enhance generic terms | Medium | Low |
...
2. Add basic Codex sections to 42 agents that have none
3. Enhance 42 agents with generic terms to have role-specific terms

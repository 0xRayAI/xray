# 0xRay Framework - Contextual Awareness Workflow (v2.0.0)
...
```typescript
// src/agents/enforcer.ts - Mapped Tools (v2.0.0)
tools: {
  include: [
    "read",
    "grep",
...
// → Checks 68 codex terms compliance
...
// Validates: all 68 codex terms, provides actionable remediation
// Coordinates with all 42 agents to ensure compliance
...
- ✅ **42 agents are mapped** to appropriate tools (14 planning, 12 implementation, 1 primary)

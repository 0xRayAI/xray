...
0xray monitor --system-health --detailed
...
0xray profile --agent architect --duration 300
...
0xray analyze --system-resources --period 1h
...
0xray diagnose --bottlenecks --comprehensive
...
0xray benchmark --comprehensive --duration 3600
...
performance_job:
  stage: monitor
  script:
    - 0xray benchmark --ci-mode --report-json
  artifacts:
    reports:

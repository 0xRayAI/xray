...
1. **test-orchestrator-simple.mjs** - Simple orchestrator routing test
   ...
   - Fix: Change import from `./node_modules/0xray/dist/plugin/src/orchestrator.js` to `./node_modules/0xray/dist/orchestrator/orchestrator.js`
...
- ✅ `./node_modules/0xray/dist/orchestrator/orchestrator.js` (for consumer tests)

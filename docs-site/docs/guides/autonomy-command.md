...
**Lead cadence:** a peer wearing the suit continues from Station + Repertoire without a command stream. Live ticks, not idle pacers. Disk SSOT: `grok-bot/ops/LEAD-CADENCE.md`. Playbook stays the `orchestrator` skill (Codex 69 — no new skill).

---
slug: "/docs/security/developer-security-onboarding"
title: "DEVELOPER SECURITY ONBOARDING"
sidebar_label: "DEVELOPER SECURITY ONBOARDING"
sidebar_position: 1
tags: ["security"]
---
...
1. **[Security Architecture Overview](/docs/security-security-architecture)**
   - Understand the multi-layered security approach
   - Learn about plugin sandboxing and permission systems

2. **[Security Best Practices](/docs/security-best-practices)**
...
**Use the [Security Code Review Checklist](/docs/security-code-review-checklist)** to review your code:
...
1. **[Incident Response Procedures](/docs/incident-response-procedures)**
   - Learn how to handle security incidents

2. **[Security Architecture](/docs/security-security-architecture)**
   - Deep dive into framework security components

3. **[StrRay Framework README](/docs/readme)**

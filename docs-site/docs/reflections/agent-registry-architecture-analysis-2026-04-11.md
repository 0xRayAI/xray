...
~15 entries are test artifacts with keywords like `stress-test-0`, `e2e-1`, `test-0.5529761171611898`, `pipeline-0` — all marked `autoGenerated: true`. These should have been cleaned up after test runs.

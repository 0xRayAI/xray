...
export class AutonomousReportGenerator {
    ...
    async generateDiagnosticReport(sessionId) {
        ...
        if (!config.autonomous_reporting.enabled) {
            ...
            throw new Error("Autonomous reporting is disabled in configuration. " +
        ...
        try {
            ...
            const sessionSummary = this.generateSessionSummary(healthAssessment, criticalIssues, recommendations);
            const report = {
            ...
            await frameworkLogger.log("autonomous-report-generator", "diagnostic-report-generated", "success", {
                reportId: report.reportId,
                sessionDuration: report.sessionDuration,
                criticalIssues: report.criticalIssues.length,
                recommendations: report.recommendations.length,
            }, sessionId, `report-${report.reportId}`);
            await frameworkLogger.log("autonomous-report-generator", "report-generated", "info", {
                reportId: report.reportId,
            ...
            await frameworkLogger.log("autonomous-report-generator", "report-generation-failed", "error", { error: error instanceof Error ? error.message : error }, sessionId);
            throw error;
        }
    }
    /**
     ...
     */
    async analyzeAgentActivities(sessionId) {
        return [
            {
     ...
     */
    async analyzePipelineOperations(sessionId) {
        return [
            {
     ...
     */
    generateSessionSummary(health, issues, recommendations) {
...
Session Summary: ${report.summary.recommendation}
     ...
     */
    scheduleAutomaticReports(intervalMinutes = 60) {
        setInterval(async () => {
            try {
...
//# sourceMappingURL=autonomous-report-generator.js.map
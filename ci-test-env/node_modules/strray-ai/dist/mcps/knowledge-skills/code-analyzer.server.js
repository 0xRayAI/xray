...
class CodeAnalyzerServer {
    ...
    constructor() {
        this.server = new Server({ name: "code-analyzer", version: "1.7.5" }, { capabilities: { tools: {} } });
    ...
    async run() {
        ...
        setTimeout(() => { try {
            ...
            setTimeout(() => cleanup("parent-death"), 1000);
        }
        catch {
            cleanup("parent-death");
        } }, 2000);
    }
}
if (import.meta.url === `file://${process.argv[1]}`) {
    new CodeAnalyzerServer().run().catch(console.error);
}

...
function logTest(name, passed, error) {
    const result = { name, passed, error: error || '' };
    results.push(result);
    if (passed) {
        log(`  ✅ ${name}`);
    }
...
async function runTests() {
    ...
    try {
        ...
        const emerging = emergingPatternDetector.isPatternEmerging("authentication login verify", testOutcomes, 0.1);
...
//# sourceMappingURL=test-p9.js.map
...
`;
    ...
    async activateGitHooks(gitHooksDir, postCommitHook, postPushHook) {
        try {
            ...
            await frameworkLogger.log("-git-hook-trigger", "-ln-s-opencode-hooks-post-commit-git-hooks-post-co", "info", {
                message: `   ln -s "../../.opencode/hooks/post-commit" ".git/hooks/post-commit"`,
            });
            await frameworkLogger.log("-git-hook-trigger", "-ln-s-opencode-hooks-post-push-git-hooks-post-push", "info", {

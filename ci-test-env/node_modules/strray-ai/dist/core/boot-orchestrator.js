...
export class BootOrchestrator {
    ...
    async activateProcessors(jobId) {
        try {
            ...
            frameworkLogger.log("boot-orchestrator", "registered preValidate processor", "success", { jobId });
            this.processorManager.registerProcessor({
            ...
            frameworkLogger.log("boot-orchestrator", "registered codexCompliance processor", "success", { jobId });
            this.processorManager.registerProcessor({
            ...
            frameworkLogger.log("boot-orchestrator", "registered testAutoCreation processor", "success", { jobId });
            this.processorManager.registerProcessor({
            ...
            frameworkLogger.log("boot-orchestrator", "registered versionCompliance processor", "success", { jobId });
            this.processorManager.registerProcessor({
                name: "errorBoundary",
                type: "pre",
                priority: 30,
            ...
            frameworkLogger.log("boot-orchestrator", "registered errorBoundary processor", "success", { jobId });
            this.processorManager.registerProcessor({
            ...
            frameworkLogger.log("boot-orchestrator", "registered agentsMdValidation processor", "success", { jobId });
            this.processorManager.registerProcessor({
            ...
            frameworkLogger.log("boot-orchestrator", "registered stateValidation processor", "success", { jobId });
            // Skip refactoring logging processor - not available in this build
            frameworkLogger.log("boot-orchestrator", "skipping refactoringLogging processor - not available", "info", { jobId });

...
export class SecurityScanner {
    ...
    async validatePrompt(prompt) {
        ...
        if (!result.isSafe) {
            console.warn(`🚨 Prompt security violation detected (risk: ${result.riskLevel}):`, result.violations);
        }
        return {
    ...
    async validateResponse(response) {
        ...
        if (!result.isSafe) {
            console.warn(`🚨 Response security violation detected (risk: ${result.riskLevel}):`, result.violations);
        }
        return {
            isSafe: result.isSafe,
            violations: result.violations,

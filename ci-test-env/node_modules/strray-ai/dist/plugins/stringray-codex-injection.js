...
**Violation of these rules will result in immediate system shutdown to prevent infinite loops.**`;
    ...
    "tool.execute.after": (tool, args, result) => {
...
function isSimpleInteraction(input) {
...
export function stringrayPlugin(input) {
...
//# sourceMappingURL=stringray-codex-injection.js.map
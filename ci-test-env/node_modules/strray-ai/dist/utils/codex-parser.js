...
function sanitizeTermDescription(description) {
    ...
    if (description.length > MAX_TERM_DESCRIPTION_LENGTH) {
        console.warn(`⚠️ Codex term description exceeded ${MAX_TERM_DESCRIPTION_LENGTH} chars, truncating. ` +
    ...
    if (repeatedPattern.test(description)) {
        console.warn("⚠️ Codex term description contains repeated patterns, indicating potential corruption. " +

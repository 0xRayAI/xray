...
class LoadBalancerIntegration extends EventEmitter {
    ...
    async updateEndpoints(newEndpoints) {
        ...
        await frameworkLogger.log("enterprise-monitoring", "-enterprise-monitor-updated-newendpoints-length-lo", "info", {
...
class AutoScalingIntegration extends EventEmitter {
    ...
    async executeScaling(decision) {
        ...
        try {
            await frameworkLogger.log("enterprise-monitoring", "-enterprise-monitor-executing-scaling-action-decis", "info", {
...
class HighAvailabilityManager extends EventEmitter {
    ...
    async initializeHighAvailability() {
        ...
        await frameworkLogger.log("enterprise-monitoring", "-enterprise-monitor-initialized-high-availability-", "info", {

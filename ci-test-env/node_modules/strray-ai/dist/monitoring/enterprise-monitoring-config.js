 ...
 */
export const basicEnterpriseConfig = {
    distributed: {
        enabled: false,
 ...
 */
export const advancedEnterpriseConfig = {
    distributed: {
        enabled: true,
    ...
    loadBalancing: {
        enabled: true,
        provider: process.env.LOAD_BALANCER_PROVIDER || "aws",
    ...
    autoScaling: {
        enabled: true,
        provider: process.env.AUTO_SCALING_PROVIDER || "aws",
    ...
    highAvailability: {
        ...
        failoverStrategy: process.env.FAILOVER_STRATEGY || "active-active",
                ...
                escalationSteps: [
                    {
                        delay: 0,
                        channels: ["pagerduty"],
                        message: "🚨 ENTERPRISE CRITICAL: {alert.title} - Cluster Impact Detected",
                    },
                    {
                        delay: 60000,
                        channels: ["slack"],
                        message: "🚨 CLUSTER CRITICAL: {alert.title} - Immediate Action Required",
                    },
                    {
                        delay: 300000,
                        channels: ["email"],
...
// =============================================================================
//# sourceMappingURL=enterprise-monitoring-config.js.map
 ...
 */
export async function archiveLogFiles(config = DEFAULT_CONFIG, jobId = `archive-${Date.now()}`) {
    ...
    if (fs.existsSync(activityLogPath)) {
        ...
        const shouldArchive = stats.size > config.maxFileSizeMB * 1024 * 1024 ||
 ...
 */
function cleanupOldArchives(maxArchives) {
    const cwd = process.cwd();
...
//# sourceMappingURL=archive-logs.js.map
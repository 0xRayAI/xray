...
export class ConnectionPool {
     ...
     */
    async acquire(serverName, config) {
        ...
        throw new Error(`Connection pool exhausted for ${serverName}. Max size: ${this.maxPoolSize}`);
    }
    /**
    ...
    async clear() {
        ...
        for (const pool of this.pools.values()) {
            for (const pooled of pool) {
                disconnectPromises.push(pooled.connection.disconnect().catch((error) => {

...
export class ProcessorLoader extends BaseLoader {
    ...
    async load() {
        ...
        try {
            ...
            await frameworkLogger.log("processor-loader", "loaded-processor-rules", "success", {
                message: `Loaded ${rules.length} processor rules`,
                ruleCount: rules.length,
            });
        }
        catch (error) {
            await frameworkLogger.log("processor-loader", "failed-to-load-processor", "error", {
     ...
     */
    createProcessorValidationRule() {
        return {
            id: "processor-validation",
            name: "Processor Validation",
            description: "Validates that processor operations follow established patterns",
     ...
     */
    async validateProcessorOperations(context) {
     ...
     * @returns Validation result
     */
    async validateProcessorHealth(context) {

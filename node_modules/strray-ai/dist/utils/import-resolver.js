...
export class ImportResolver {
    ...
    generateAlternativePaths(moduleName, subPath) {
        ...
        const paths = [];
        if (this.isDevelopment) {
            paths.push(join(this.currentDir, "..", `${fullModuleName}.js`), join(this.currentDir, "..", `${fullModuleName}.ts`), `./${fullModuleName}.ts`);
        }
        else {
            paths.push(join(this.currentDir, "..", `${fullModuleName}.ts`), join(this.currentDir, "..", `${fullModuleName}.js`), `./${fullModuleName}.js`);
        }

...
export class ImportResolver {
     ...
     */
    resolveModulePath(moduleName, subPath = "") {
     ...
     */
    async importModule(moduleName, subPath = "") {
        ...
        try {
            ...
            try {
                const rootPath = join(this.projectRoot, "dist", subPath, `${moduleName}.js`);
     ...
     */
    generateAlternativePaths(moduleName, subPath) {
        const fullModuleName = subPath ? `${subPath}/${moduleName}` : moduleName;
        const paths = [];
        if (this.isDevelopment) {
            // Development alternatives
            paths.push(`../dist/${fullModuleName}.js`, `../src/${fullModuleName}.ts`, `./${fullModuleName}.ts`, `../dist/${fullModuleName}.js`);
        }
        else {
            // Built/deployed alternatives
            paths.push(`../src/${fullModuleName}.ts`, `../dist/${fullModuleName}.js`, `./${fullModuleName}.js`, `../dist/${fullModuleName}.js`);
        }
        // Add absolute paths as last resort
        try {
            const absPath = resolve(this.projectRoot, "dist", subPath, `${moduleName}.js`);
            paths.push(absPath);
        }
        catch {

...
export class LogProtectionProcessor extends PreProcessor {
    ...
    async run(context) {
        ...
        if (this.isArchiveCleanup(normalizedPath)) {
            frameworkLogger.log("log-protection-processor", "archive-cleanup-allowed", "info", { filePath: normalizedPath, operation });
        ...
        if (activeFile) {
            frameworkLogger.log("log-protection-processor", "deletion-blocked", "warning", {
    ...
    getOperation(context) {
        return (context.operation || context.toolInput?.args?.operation);
    }
}
export const logProtectionProcessor = new LogProtectionProcessor();
//# sourceMappingURL=log-protection-processor.js.map
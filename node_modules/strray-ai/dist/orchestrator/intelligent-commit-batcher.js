...
export class IntelligentCommitBatcher {
    ...
    loadFeaturesConfig() {
        try {
            ...
            frameworkLogger.log("intelligent-commit-batcher", "config-load-failed", "warning", { error: e instanceof Error ? e.message : String(e) });
        }
        return null;
    }
    /**
    ...
    async performGitCommit(message) {
        try {
            const result = await runCommandSafe("git", ["commit", "-m", message], { silent: true });

...
export class PatternPerformanceTracker {
    patternMetrics = new Map();
    maxTimeSeriesPoints = 1000;
    driftThreshold = 0.15; // 15% change triggers drift detection
    minSamplesForDrift = 10;
    baselineWindowSize = 100;
    /**
     * Track performance metrics for a pattern
     */
    trackPatternPerformance(patternId, outcome) {
        ...
        frameworkLogger.log("pattern-performance-tracker", "metrics-updated", "debug", {
            patternId,
    ...
    clear() {
        ...
        frameworkLogger.log("pattern-performance-tracker", "cleared", "info", {}, undefined);
    }
    /**
        ...
        try {
            ...
            if (fs.existsSync(filePath)) {
                ...
                for (const [key, value] of Object.entries(data)) {
                    this.patternMetrics.set(key, value);
                }
            }
        }
        catch (error) {
...
//# sourceMappingURL=pattern-performance-tracker.js.map
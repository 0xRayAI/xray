...
import { featuresConfigLoader, detectTaskType, } from "./features-config.js";
// ============================================================================
// Model Router Class
// ============================================================================
class ModelRouter {
    ...
    getValidatedModel(agentType) {
        ...
        // 5. Ultimate fallback
        const fallbackModel = featuresConfig.model_routing?.fallback_model ||
...
export const getModelForTask = (context) => modelRouter.getModelForTask(context);
export const getModelForTaskType = (taskType) => modelRouter.getModelForTaskType(taskType);
export const getValidatedModel = (agentType) => modelRouter.getValidatedModel(agentType);

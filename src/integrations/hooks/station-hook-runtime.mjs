...
export const isKeywordDestName = impl.isKeywordDestName;
export const pruneKeywordDest = impl.pruneKeywordDest;
export const preferLawHits = impl.preferLawHits;
export const retainCompactFields = impl.retainCompactFields;
export const destLawNameSet = impl.destLawNameSet;

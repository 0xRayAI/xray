...
class XrayCodeReviewServer extends XrayKnowledgeSkillBase {
  ...
  constructor() {
    ...
    this.handlers = {
      "analyze_code_quality": async (args) => this.analyzeCodeQuality(args as AnalyzeCodeQualityArgs),
      "review_pull_request": async (args) => this.reviewPullRequest(args as ReviewPullRequestArgs),
      "check_best_practices": async (args) => this.checkBestPractices(args as CheckBestPracticesArgs),

 ...
 *
 * Maps UI/UX design tasks to the frontend-ui-ux-engineer agent.
 * Includes component design, styling, layout, and interface creation.
 */

import type { RoutingMapping } from '../types.js';

export const UI_UX_MAPPINGS: RoutingMapping[] = [
  {
    keywords: [

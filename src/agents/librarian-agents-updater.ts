...
export class LibrarianAgentsUpdater {
   ...
   */
  private generateAutoGeneratedContent(info: ProjectInfo): string {
   ...
   */
  private mergeAgentsMd(agentsPath: string, autoContent: string): string {
...
`;
  ...
  private generateAgentsMd(info: ProjectInfo): string {
    ...
    sections.push("");
    sections.push(
      "0xRay has one plugin system for OpenCode integration:",
    );
    sections.push("");
    sections.push("### OpenCode Plugin (`.opencode/plugin/`)");
    sections.push("**Purpose:** Injects 0xRay into OpenCode framework");

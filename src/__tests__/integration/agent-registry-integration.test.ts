...
describe("Agent Registry Integration", () => {
  ...
  it("routing-mappings.json agents all exist in registry", () => {
    const srcPath = path.resolve(process.cwd(), "src/opencode/strray/routing-mappings.json");
    const genPath = path.resolve(process.cwd(), ".opencode/strray/routing-mappings.json");

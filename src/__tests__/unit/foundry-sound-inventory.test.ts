...
describe('foundry sound + picture inventory — bar 8', () => {
  it('seats every live voice and picture motion at or above 8', { timeout: 40000 }, () => {
    ...
    ) as { bar: number; voices: Array<{ id: string; taste: number }> };

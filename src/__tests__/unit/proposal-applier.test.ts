...
const { mockExistsSync, mockMkdirSync, mockWriteFileSync, mockAppendFileSync, mockReadFileSync, mockPathJoin, mockPathDirname, mockPathRelative } = vi.hoisted(() => {
...
describe("ProposalApplier", () => {
  ...
  it("codify type — handled directly", async () => {
